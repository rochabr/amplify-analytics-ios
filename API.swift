...
public struct CreateDealInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, name: String, category: String) {
    graphQLMap = ["id": id, "name": name, "category": category]
  }
...
public struct ModelDealConditionInput: GraphQLMapConvertible {
  ...
  public init(name: ModelStringInput? = nil, category: ModelStringInput? = nil, and: [ModelDealConditionInput?]? = nil, or: [ModelDealConditionInput?]? = nil, not: ModelDealConditionInput? = nil) {
    graphQLMap = ["name": name, "category": category, "and": and, "or": or, "not": not]
  }
...
public struct UpdateDealInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, name: String? = nil, category: String? = nil) {
    graphQLMap = ["id": id, "name": name, "category": category]
  }
...
public struct ModelDealFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, name: ModelStringInput? = nil, category: ModelStringInput? = nil, and: [ModelDealFilterInput?]? = nil, or: [ModelDealFilterInput?]? = nil, not: ModelDealFilterInput? = nil) {
    graphQLMap = ["id": id, "name": name, "category": category, "and": and, "or": or, "not": not]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct ListDeal: GraphQLSelectionSet {
      ...
      public init(items: [Item?]? = nil, nextToken: String? = nil) {
        self.init(snapshot: ["__typename": "ModelDealConnection", "items": items.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "nextToken": nextToken])
      }
